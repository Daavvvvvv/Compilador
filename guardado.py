#importamos de la libreria ply la funcion yaceyla renombramos como yacc
...
resultado_gramatica=[]
#definimos la precedencia para evitar errores en nuestro analizador
#definimos cuales tokens tiene mayor prioridad
#cuales tenemos que analizarlos por la derechaopor la izquierda
precedence= (
    ('right','ASIGNAR'),
    ('left','SUMA','RESTA'),
    ('left','MULT','DIV'),
...
def p_error(t):
    ...
    if t:
        resultado= "Error sintatico de tipo {} en el valor {}".format(str(t.type),str(t.value))
        print(resultado)
...
#realiza el analisis sintactico de todo el codigo
parser = yacc.yacc()
